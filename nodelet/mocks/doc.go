...
//go:generate go run -mod=mod github.com/golang/mock/mockgen -package mocks -destination=./mock_checkservice.go -source=../pkg/utils/command/check_service.go -build_flags=-mod=mod
