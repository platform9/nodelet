...
ETCD_DATA_DIR: {{ or .EtcdDataDir "/var/opt/pf9/kube/etcd/data" }}
ETCD_DISCOVERY_URL: {{ .EtcdDiscoveryUrl }}
ETCD_ELECTION_TIMEOUT: {{ or .EtcdElectionTimeout "1000" }}
ETCD_ENV: |-
  ETCD_NAME={{ .HostId }}
...
ETCD_HEARTBEAT_INTERVAL: {{ or .EtcdHeartbeatInterval "100" }}
ETCD_VERSION: {{ .EtcdVersion }}
EXTERNAL_DNS_NAME: ""
EXTRA_OPTS: ""
